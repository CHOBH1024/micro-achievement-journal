    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      ...
      <header className="border-b border-slate-800 bg-slate-900/80 px-6 py-4 flex justify-between items-center max-w-4xl mx-auto w-full sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-base text-white tracking-tight uppercase">Micro Achievement Journal</span>
      ...
      <main className="max-w-2xl mx-auto px-6 py-10 w-full flex-1">
        ...
        {activeTab === 'tool' && (
          <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-xl">
            <h2 className="text-xl font-bold text-white mb-2">Micro Achievement Journal</h2>
            <p className="text-xs text-slate-400 mb-6">오늘의 소소한 성취 칭찬 도장 & 칭찬 피드</p>
      ...
      <footer className="border-t border-slate-800 py-4 text-center text-[10px] text-slate-500">
        © 2026 Micro Achievement Journal. AWS Serverless Live Analytics & Community. Powered by Pomyjo.
      </footer>
    </div>
  );
}
